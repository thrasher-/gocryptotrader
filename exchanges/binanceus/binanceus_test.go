...
func TestServerStatus(t *testing.T) {
	...
	require.NoError(t, err, "GetSystemStatus must not return error")
}

func TestGetExchangeInfo(t *testing.T) {
	t.Parallel()
	_, err := e.GetExchangeInfo(t.Context())
	require.NoError(t, err, "GetExchangeInfo must not return error")
}

func TestUpdateTicker(t *testing.T) {
	t.Parallel()
	r, err := e.UpdateTicker(t.Context(), testPairMapping, asset.Spot)
	require.NoError(t, err, "UpdateTicker must not return error")
...
func TestUpdateTickers(t *testing.T) {
	...
	require.NoError(t, err, "UpdateTickers must not return error")
}

func TestUpdateOrderBook(t *testing.T) {
	t.Parallel()
	_, err := e.UpdateOrderbook(t.Context(), testPairMapping, asset.Spot)
	require.NoError(t, err, "UpdateOrderbook must not return error")
}
...
func TestFetchTradablePairs(t *testing.T) {
	...
	require.NoError(t, err, "FetchTradablePairs must not return error")
}

func TestUpdateTradablePairs(t *testing.T) {
	t.Parallel()
	err := e.UpdateTradablePairs(t.Context(), false)
	require.NoError(t, err, "UpdateTradablePairs must not return error")
}
...
func TestUpdateAccountInfo(t *testing.T) {
	...
	require.NoError(t, err, "UpdateAccountInfo must not return error")
}
...
func TestGetRecentTrades(t *testing.T) {
	...
	require.NoError(t, err, "GetRecentTrades must not return error")
}
...
func TestGetHistoricTrades(t *testing.T) {
	...
	require.NoError(t, err, "GetHistoricTrades must not return error")
}
...
func TestGetMostRecentTrades(t *testing.T) {
	...
	require.NoError(t, err, "GetMostRecentTrades must not return error")
}
...
func TestGetHistoricalTrades(t *testing.T) {
	...
	require.NoError(t, err, "GetHistoricalTrades must not return error")
}
...
func TestGetAggregateTrades(t *testing.T) {
	...
	require.NoError(t, err, "GetAggregateTrades must not return error")
}

func TestGetOrderBookDepth(t *testing.T) {
	t.Parallel()
	_, err := e.GetOrderBookDepth(t.Context(), &OrderBookDataRequestParams{
		Symbol: currency.NewBTCUSDT(),
		Limit:  1000,
	})
	require.NoError(t, err, "GetOrderBookDepth must not return error")
}
...
func TestGetCandlestickData(t *testing.T) {
	...
	require.NoError(t, err, "GetSpotKline must not return error")
}

func TestGetPriceDatas(t *testing.T) {
	t.Parallel()
	_, err := e.GetPriceDatas(t.Context())
	require.NoError(t, err, "GetPriceDatas must not return error")
}
...
func TestGetSinglePriceData(t *testing.T) {
	...
	require.NoError(t, err, "GetSinglePriceData must not return error")
}

func TestGetAveragePrice(t *testing.T) {
	t.Parallel()
	_, err := e.GetAveragePrice(t.Context(), currency.NewBTCUSDT())
	require.NoError(t, err, "GetAveragePrice must not return error")
}

func TestGetBestPrice(t *testing.T) {
	t.Parallel()
	_, err := e.GetBestPrice(t.Context(), currency.NewBTCUSDT())
	require.NoError(t, err, "GetBestPrice must not return error")
}

func TestGetPriceChangeStats(t *testing.T) {
	t.Parallel()
	_, err := e.GetPriceChangeStats(t.Context(), currency.NewBTCUSDT())
	require.NoError(t, err, "GetPriceChangeStats must not return error")
}

func TestGetTickers(t *testing.T) {
	t.Parallel()
	_, err := e.GetTickers(t.Context())
	require.NoError(t, err, "GetTickers must not return error")
}
...
func TestGetAccount(t *testing.T) {
	...
	require.NoError(t, err, "GetAccount must not return error")
}
...
func TestGetUserAccountStatus(t *testing.T) {
	...
	require.NoError(t, err, "GetUserAccountStatus must not return error")
}
...
func TestGetUserAPITradingStatus(t *testing.T) {
	...
	require.NoError(t, err, "GetUserAPITradingStatus must not return error")
}
...
func TestGetTradeFee(t *testing.T) {
	...
	require.NoError(t, err, "GetTradeFee must not return error")
}
...
func TestGetAssetDistributionHistory(t *testing.T) {
	...
	require.NoError(t, err, "GetAssetDistributionHistory must not return error")
}
...
func TestGetOrderRateLimits(t *testing.T) {
	...
	require.NoError(t, err, "GetOrderRateLimits must not return error")
}
...
func TestGetAllOpenOrders(t *testing.T) {
	...
	require.NoError(t, err, "GetAllOpenOrders must not return error")
}
...
func TestGetAllOCOOrder(t *testing.T) {
	...
	require.NoError(t, err, "GetAllOCOOrder must not return error")
}
...
func TestGetOpenOCOOrders(t *testing.T) {
	...
	require.NoError(t, err, "GetOpenOCOOrders must not return error")
}
...
func TestGetSupportedCoinPairs(t *testing.T) {
	...
	require.NoError(t, err, "GetSupportedCoinPairs must not return error")
}
...
func TestGetAllOTCTradeOrders(t *testing.T) {
	...
	require.NoError(t, err, "GetAllOTCTradeOrders must not return error")
}
...
func TestGetAllOCBSTradeOrders(t *testing.T) {
	...
	require.NoError(t, err, "GetAllOCBSTradeOrders must not return error")
}
...
func TestGetAssetFeesAndWalletStatus(t *testing.T) {
	...
	require.NoError(t, err, "GetAssetFeesAndWalletStatus must not return error")
}
...
func TestFiatWithdrawalHistory(t *testing.T) {
	...
	require.NoError(t, err, "FiatWithdrawalHistory must not return error")
}
...
func TestDepositHistory(t *testing.T) {
	...
	require.NoError(t, err, "DepositHistory must not return error")
}
...
func TestFiatDepositHistory(t *testing.T) {
	...
	require.NoError(t, err, "FiatDepositHistory must not return error")
}
...
func TestWebsocketStreamKey(t *testing.T) {
	...
	require.NoError(t, err, "GetWsAuthStreamKey must not return error")
	err = e.MaintainWsAuthStreamKey(t.Context())
	require.NoError(t, err, "MaintainWsAuthStreamKey must not return error")
	err = e.CloseUserDataStream(t.Context())
	require.NoError(t, err, "CloseUserDataStream must not return error")
}
...
func TestGetSubscriptions(t *testing.T) {
	...
	require.NoError(t, err, "GetSubscriptions must not return error")
}
...
func TestWebsocketOrderBookDepthDiffStream(t *testing.T) {
	...
	if err := e.SeedLocalCacheWithBook(p, &book); err != nil {
		require.NoError(t, err, "SeedLocalCacheWithBook must not return error")
	}
	...
	require.NoError(t, err, "Orderbook.GetOrderbook must not return error")
...
func TestProcessUpdate(t *testing.T) {
	...
	require.NoError(t, err, "stageWsUpdate must not return error")
	err = e.obm.fetchBookViaREST(p)
	require.NoError(t, err, "fetchBookViaREST must not return error")
	err = e.obm.cleanup(p)
	require.NoError(t, err, "cleanup must not return error")
	e.obm.state[currency.BTC][currency.USDT][asset.Spot].lastUpdateID = 0
}
...
func TestGetUsersSpotAssetSnapshot(t *testing.T) {
	...
	require.NoError(t, err, "GetUsersSpotAssetSnapshot must not return error")
}
