...
func (e *Exchange) Withdraw(ctx context.Context, req *WithdrawRequest) (string, error) {
	...
	err := e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, "Withdraw", params, &response)
	if err != nil {
		return "", err
	}
...
func (e *Exchange) GetWebsocketToken(ctx context.Context) (string, error) {
	...
	err := e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, "GetWebSocketsToken", nil, &response)
	if err != nil {
		return "", err
	}
...
// GetAPIKeyInfo returns metadata for the API key used for the request.
func (e *Exchange) GetAPIKeyInfo(ctx context.Context, _ *GetAPIKeyInfoRequest) (*GetAPIKeyInfoResponse, error) {
	var result *GetAPIKeyInfoResponse
	return result, e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, "GetApiKeyInfo", nil, &result)
}
