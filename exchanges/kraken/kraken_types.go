...
import (
	...
	types "github.com/thrasher-corp/gocryptotrader/types"
)
...
// GetAPIKeyInfoRequest defines request params for the API key info endpoint.
type GetAPIKeyInfoRequest struct{}

// GetAPIKeyInfoResponse defines API key metadata for the authenticated key.
...
// EarnStrategyAutoCompound defines auto-compounding behaviour.
