...
func TestListSpotCurrencies(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s ListSpotCurrencies should not error", e.Name)
}

func TestGetCurrencyDetail(t *testing.T) {
	t.Parallel()
	_, err := e.GetCurrencyDetail(t.Context(), currency.BTC)
	assert.NoErrorf(t, err, "%s GetCurrencyDetail should not error", e.Name)
}

func TestListAllCurrencyPairs(t *testing.T) {
	t.Parallel()
	_, err := e.ListSpotCurrencyPairs(t.Context())
	assert.NoErrorf(t, err, "%s ListSpotCurrencyPairs should not error", e.Name)
}
...
func TestGetCurrencyPairDetal(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetCurrencyPairDetail should not error", e.Name)
}

func TestGetTickers(t *testing.T) {
	t.Parallel()
	_, err := e.GetTickers(t.Context(), "BTC_USDT", "")
	assert.NoErrorf(t, err, "%s GetTickers should not error", e.Name)
}
...
func TestGetTicker(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetTicker should not error", e.Name)
}
...
func TestGetMarketTrades(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetMarketTrades should not error", e.Name)
}
...
func TestGetCandlesticks(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetCandlesticks should not error", e.Name)
}
...
func TestGetTradingFeeRatio(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetTradingFeeRatio should not error", e.Name)
}
...
func TestGetSpotAccounts(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetSpotAccounts should not error", e.Name)
}
...
func TestGetSpotOpenOrders(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetSpotOpenOrders should not error", e.Name)
}
...
func TestSpotClosePositionWhenCrossCurrencyDisabled(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s SpotClosePositionWhenCrossCurrencyDisabled should not error", e.Name)
}
...
func TestCancelAllOpenOrdersSpecifiedCurrencyPair(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s CancelAllOpenOrdersSpecifiedCurrencyPair should not error", e.Name)
}
...
func TestCancelBatchOrdersWithIDList(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s CancelBatchOrdersWithIDList should not error", e.Name)
}
...
func TestGetSpotOrder(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetSpotOrder should not error", e.Name)
}
...
func TestAmendSpotOrder(t *testing.T) {
	...
	assert.NoError(t, err, "AmendSpotOrder should not error for valid request")
}
...
func TestCancelSingleSpotOrder(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s CancelSingleSpotOrder should not error", e.Name)
}
...
func TestGetServerTime(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetServerTime should not error", e.Name)
}

func TestCountdownCancelorder(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	_, err := e.CountdownCancelorders(t.Context(), CountdownCancelOrderParam{
		Timeout:      10,
		CurrencyPair: currency.Pair{Base: currency.BTC, Quote: currency.ETH, Delimiter: currency.UnderscoreDelimiter},
	})
	assert.NoErrorf(t, err, "%s CountdownCancelorders should not error", e.Name)
}
...
func TestCreatePriceTriggeredOrder(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s CreatePriceTriggeredOrder should not error", e.Name)
}
...
func TestCancelAllOpenOrders(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s CancelMultipleSpotOpenOrders should not error", e.Name)
}
...
func TestGetSinglePriceTriggeredOrder(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetSinglePriceTriggeredOrder should not error", e.Name)
}
...
func TestCancelPriceTriggeredOrder(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s CancelPriceTriggeredOrder should not error", e.Name)
}
...
func TestGetMarginAccountList(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetMarginAccountList should not error", e.Name)
}
...
func TestListMarginAccountBalanceChangeHistory(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s ListMarginAccountBalanceChangeHistory should not error", e.Name)
}
...
func TestGetMarginFundingAccountList(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetMarginFundingAccountList should not error", e.Name)
}
...
func TestMarginLoan(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s MarginLoan should not error", e.Name)
}
...
func TestMergeMultipleLendingLoans(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s MergeMultipleLendingLoans should not error", e.Name)
}
...
func TestRetriveOneSingleLoanDetail(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s RetriveOneSingleLoanDetail should not error", e.Name)
}
...
func TestModifyALoan(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s ModifyALoan should not error with credentials", e.Name)
}
...
func TestCancelLendingLoan(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s CancelLendingLoan should not error", e.Name)
}
...
func TestRepayALoan(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s RepayALoan should not error", e.Name)
}
...
func TestListLoanRepaymentRecords(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s ListLoanRepaymentRecords should not error", e.Name)
}
...
func TestListRepaymentRecordsOfSpecificLoan(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s ListRepaymentRecordsOfSpecificLoan should not error", e.Name)
}

func TestGetOneSingleloanRecord(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e)
	_, err := e.GetOneSingleLoanRecord(t.Context(), "1234", "123")
	assert.NoErrorf(t, err, "%s GetOneSingleLoanRecord should not error", e.Name)
}
...
func TestModifyALoanRecord(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s ModifyALoanRecord should not error", e.Name)
}
...
func TestUpdateUsersAutoRepaymentSetting(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s UpdateUsersAutoRepaymentSetting should not error", e.Name)
}
...
func TestGetUserAutoRepaymentSetting(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetUserAutoRepaymentSetting should not error", e.Name)
}
...
func TestGetMaxTransferableAmountForSpecificMarginCurrency(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetMaxTransferableAmountForSpecificMarginCurrency should not error", e.Name)
}
...
func TestGetMaxBorrowableAmountForSpecificMarginCurrency(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetMaxBorrowableAmountForSpecificMarginCurrency should not error", e.Name)
}
...
func TestCurrencySupportedByCrossMargin(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s CurrencySupportedByCrossMargin should not error", e.Name)
}
...
func TestGetCrossMarginSupportedCurrencyDetail(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetCrossMarginSupportedCurrencyDetail should not error", e.Name)
}
...
func TestGetCrossMarginAccounts(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetCrossMarginAccounts should not error", e.Name)
}
...
func TestGetCrossMarginAccountChangeHistory(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetCrossMarginAccountChangeHistory should not error", e.Name)
}
...
func TestCreateCrossMarginBorrowLoan(t *testing.T) {
	...
	assert.NoErrorf(t, json.Unmarshal([]byte(createCrossMarginBorrowLoanJSON), &response), "%s should unmarshal CrossMarginBorrowLoanResponse", e.Name)
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	_, err := e.CreateCrossMarginBorrowLoan(t.Context(), CrossMarginBorrowLoanParams{
		Currency: currency.BTC,
		Amount:   3,
	})
	assert.NoErrorf(t, err, "%s CreateCrossMarginBorrowLoan should not error", e.Name)
}
...
func TestGetCrossMarginBorrowHistory(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetCrossMarginBorrowHistory should not error", e.Name)
}
...
func TestGetSingleBorrowLoanDetail(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetSingleBorrowLoanDetail should not error", e.Name)
}
...
func TestExecuteRepayment(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s ExecuteRepayment should not error", e.Name)
}
...
func TestGetCrossMarginRepayments(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetCrossMarginRepayments should not error", e.Name)
}
...
func TestGetMaxTransferableAmountForSpecificCrossMarginCurrency(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetMaxTransferableAmountForSpecificCrossMarginCurrency should not error", e.Name)
}
...
func TestGetMaxBorrowableAmountForSpecificCrossMarginCurrency(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetMaxBorrowableAmountForSpecificCrossMarginCurrency should not error", e.Name)
}

func TestListCurrencyChain(t *testing.T) {
	t.Parallel()
	_, err := e.ListCurrencyChain(t.Context(), currency.BTC)
	assert.NoErrorf(t, err, "%s ListCurrencyChain should not error", e.Name)
}
...
func TestGenerateCurrencyDepositAddress(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GenerateCurrencyDepositAddress should not error", e.Name)
}
...
func TestGetWithdrawalRecords(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetWithdrawalRecords should not error", e.Name)
}
...
func TestGetDepositRecords(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetDepositRecords should not error", e.Name)
}
...
func TestTransferCurrency(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s TransferCurrency should not error", e.Name)
}
...
func TestGetSubAccountTransferHistory(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetSubAccountTransferHistory should not error", e.Name)
}

func TestSubAccountTransferToSubAccount(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	assert.NoErrorf(t, e.SubAccountTransferToSubAccount(t.Context(), &InterSubAccountTransferParams{
		Currency:                currency.BTC,
		...
		Amount:                  1234,
	}), "%s SubAccountTransferToSubAccount should not error", e.Name)
}
...
func TestGetWithdrawalStatus(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetWithdrawalStatus should not error", e.Name)
}
...
func TestGetSubAccountBalances(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetSubAccountBalances should not error", e.Name)
}
...
func TestGetSubAccountMarginBalances(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetSubAccountMarginBalances should not error", e.Name)
}
...
func TestGetSubAccountFuturesBalances(t *testing.T) {
	...
	assert.Error(t, err, "GetSubAccountFuturesBalances should error when account ID empty")
}
...
func TestGetSubAccountCrossMarginBalances(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetSubAccountCrossMarginBalances should not error", e.Name)
}
...
func TestGetSavedAddresses(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetSavedAddresses should not error", e.Name)
}
...
func TestGetUsersTotalBalance(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetUsersTotalBalance should not error", e.Name)
}

func TestGetMarginSupportedCurrencyPairs(t *testing.T) {
	t.Parallel()
	_, err := e.GetMarginSupportedCurrencyPairs(t.Context())
	assert.NoErrorf(t, err, "%s GetMarginSupportedCurrencyPairs should not error", e.Name)
}
...
func TestGetMarginSupportedCurrencyPair(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetSingleMarginSupportedCurrencyPair should not error", e.Name)
}

func TestGetOrderbookOfLendingLoans(t *testing.T) {
	t.Parallel()
	_, err := e.GetOrderbookOfLendingLoans(t.Context(), currency.BTC)
	assert.NoErrorf(t, err, "%s GetOrderbookOfLendingLoans should not error", e.Name)
}
...
func TestGetAllDeliveryContracts(t *testing.T) {
	...
	require.NoError(t, err, "GetAllDeliveryContracts must not error")
	assert.Empty(t, r, "GetAllDeliveryContracts should return no data for unsupported BTC settlement; BTC settlement for delivery futures appears enabled so please raise an issue to reintroduce support")
}
...
func TestGetAllOptionsUnderlyings(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetAllOptionsUnderlyings should not error", e.Name)
}
...
func TestGetAllContractOfUnderlyingWithinExpiryDate(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetAllContractOfUnderlyingWithinExpiryDate should not error", e.Name)
}
...
func TestGetOptionsSpecifiedContractDetail(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetOptionsSpecifiedContractDetail should not error", e.Name)
}

func TestGetSettlementHistory(t *testing.T) {
	t.Parallel()
	_, err := e.GetSettlementHistory(t.Context(), "BTC_USDT", 0, 0, time.Time{}, time.Time{})
	assert.NoErrorf(t, err, "%s GetSettlementHistory should not error", e.Name)
}
...
func TestGetOptionsSpecifiedSettlementHistory(t *testing.T) {
	...
	require.NoError(t, err, "GetSettlementHistory must not error for options")
	cp, err := currency.NewPairFromString(optionsSettlement[0].Contract)
	require.NoError(t, err, "currency.NewPairFromString must not error")
	_, err = e.GetOptionsSpecifiedContractsSettlement(t.Context(), cp, underlying, optionsSettlement[0].Timestamp.Time().Unix())
	assert.NoErrorf(t, err, "%s GetOptionsSpecifiedContractsSettlement should not error", e.Name)
}

func TestGetSupportedFlashSwapCurrencies(t *testing.T) {
	t.Parallel()
	_, err := e.GetSupportedFlashSwapCurrencies(t.Context())
	assert.NoErrorf(t, err, "%s GetSupportedFlashSwapCurrencies should not error", e.Name)
}
...
func TestCreateFlashSwapOrder(t *testing.T) {
	...
	assert.NoErrorf(t, json.Unmarshal([]byte(flashSwapOrderResponseJSON), &response), "%s should unmarshal FlashSwapOrderResponse", e.Name)
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	...
	assert.NoErrorf(t, err, "%s CreateFlashSwapOrder should not error", e.Name)
}
...
func TestGetAllFlashSwapOrders(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetAllFlashSwapOrders should not error", e.Name)
}
...
func TestGetSingleFlashSwapOrders(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetSingleFlashSwapOrder should not error", e.Name)
}
...
func TestInitiateFlashSwapOrderReview(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s InitiateFlashSwapOrderReview should not error", e.Name)
}
...
func TestGetMyOptionsSettlements(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetMyOptionsSettlements should not error", e.Name)
}
...
func TestGetOptionAccounts(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetOptionAccounts should not error", e.Name)
}
...
func TestGetAccountChangingHistory(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetAccountChangingHistory should not error", e.Name)
}
...
func TestGetUsersPositionSpecifiedUnderlying(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetUsersPositionSpecifiedUnderlying should not error", e.Name)
}
...
func TestGetUsersLiquidationHistoryForSpecifiedUnderlying(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetUsersLiquidationHistoryForSpecifiedUnderlying should not error", e.Name)
}
...
func TestPlaceOptionOrder(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s PlaceOptionOrder should not error", e.Name)
}
...
func TestGetOptionFuturesOrders(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetOptionFuturesOrders should not error", e.Name)
}
...
func TestCancelOptionOpenOrders(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s CancelMultipleOptionOpenOrders should not error", e.Name)
}
...
func TestCancelSingleOrder(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s CancelOptionSingleOrder should not error", e.Name)
}
...
func TestWithdrawCurrency(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s WithdrawCurrency should not error with valid request", e.Name)
}
...
func TestCancelWithdrawalWithSpecifiedID(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s CancelWithdrawalWithSpecifiedID should not error", e.Name)
}
...
func TestGetOptionsTickers(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetOptionsTickers should not error", e.Name)
}

func TestGetOptionUnderlyingTickers(t *testing.T) {
	t.Parallel()
	_, err := e.GetOptionUnderlyingTickers(t.Context(), "BTC_USDT")
	assert.NoErrorf(t, err, "%s GetOptionUnderlyingTickers should not error", e.Name)
}
...
func TestGetOptionFuturesCandlesticks(t *testing.T) {
	...
	assert.NoError(t, err, "GetOptionFuturesCandlesticks should not error")
}
...
func TestGetOptionFuturesMarkPriceCandlesticks(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetOptionFuturesMarkPriceCandlesticks should not error", e.Name)
}
...
func TestGetOptionsTradeHistory(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetOptionsTradeHistory should not error", e.Name)
}
...
func TestCreateNewSubAccount(t *testing.T) {
	t.Parallel()
	sharedtestvalues.SkipTestIfCredentialsUnset(t, e, canManipulateRealOrders)
	_, err := e.CreateNewSubAccount(t.Context(), SubAccountParams{LoginName: "Sub_Account_for_testing"})
	assert.NoErrorf(t, err, "%s CreateNewSubAccount should not error", e.Name)
}
...
func TestGetSubAccounts(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetSubAccounts should not error", e.Name)
}
...
func TestGetSingleSubAccount(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetSingleSubAccount should not error", e.Name)
}
...
func TestGetWithdrawalsHistory(t *testing.T) {
	...
	assert.NoErrorf(t, err, "%s GetWithdrawalsHistory should not error", e.Name)
}
...
func TestGetDepositAddress(t *testing.T) {
	...
	require.NoError(t, err, "GetAvailableTransferChains must not return error")
	for i := range chains {
		_, err = e.GetDepositAddress(t.Context(), currency.BTC, "", chains[i])
		assert.NoErrorf(t, err, "GetDepositAddress should not error for chain %s", chains[i])
	}
}
...
func TestGetAvailableTransferTrains(t *testing.T) {
	...
	assert.NoError(t, err, "GetAvailableTransferChains should not error for USDT")
}
...
func TestGetUnderlyingFromCurrencyPair(t *testing.T) {
	...
	assert.True(t, uly.Equal(currency.NewBTCUSDT()), "GetUnderlyingFromCurrencyPair should return BTC_USDT")
}
...
func TestWsTickerPushData(t *testing.T) {
	t.Parallel()
	assert.NoErrorf(t, e.WsHandleSpotData(t.Context(), nil, []byte(wsTickerPushDataJSON)), "%s websocket ticker push data should not error", e.Name)
}
...
func TestWsTradePushData(t *testing.T) {
	t.Parallel()
	assert.NoErrorf(t, e.WsHandleSpotData(t.Context(), nil, []byte(wsTradePushDataJSON)), "%s websocket trade push data should not error", e.Name)
}
...
func TestWsCandlestickPushData(t *testing.T) {
	t.Parallel()
	assert.NoErrorf(t, e.WsHandleSpotData(t.Context(), nil, []byte(wsCandlestickPushDataJSON)), "%s websocket candlestick push data should not error", e.Name)
}
...
func TestWsOrderbookTickerPushData(t *testing.T) {
	t.Parallel()
	assert.NoErrorf(t, e.WsHandleSpotData(t.Context(), nil, []byte(wsOrderbookTickerJSON)), "%s websocket orderbook ticker push data should not error", e.Name)
}
...
func TestWsOrderbookSnapshotPushData(t *testing.T) {
	t.Parallel()
	require.NoErrorf(t, e.WsHandleSpotData(t.Context(), nil, []byte(wsOrderbookSnapshotPushDataJSON)), "%s websocket orderbook snapshot push data must not error", e.Name)
	require.NoErrorf(t, e.WsHandleSpotData(t.Context(), nil, []byte(wsOrderbookUpdatePushDataJSON)), "%s websocket orderbook update push data must not error", e.Name)
}
...
func TestWsPushOrders(t *testing.T) {
	t.Parallel()
	assert.NoErrorf(t, e.WsHandleSpotData(t.Context(), nil, []byte(wsSpotOrderPushDataJSON)), "%s websocket orders push data should not error", e.Name)
}
...
func TestWsUserTradesPushDataJSON(t *testing.T) {
	t.Parallel()
	assert.NoErrorf(t, e.WsHandleSpotData(t.Context(), nil, []byte(wsUserTradePushDataJSON)), "%s websocket user trade push data should not error", e.Name)
}
...
func TestBalancesPushData(t *testing.T) {
	...
	assert.NoErrorf(t, e.WsHandleSpotData(ctx, nil, []byte(wsBalancesPushDataJSON)), "%s websocket balances push data should not error", e.Name)
}
...
func TestMarginBalancePushData(t *testing.T) {
	t.Parallel()
	assert.NoErrorf(t, e.WsHandleSpotData(t.Context(), nil, []byte(wsMarginBalancePushDataJSON)), "%s websocket margin balance push data should not error", e.Name)
}
...
func TestCrossMarginBalancePushData(t *testing.T) {
	t.Parallel()
	ctx := account.DeployCredentialsToContext(t.Context(), &account.Credentials{Key: "test", Secret: "test"})
	assert.NoErrorf(t, e.WsHandleSpotData(ctx, nil, []byte(wsCrossMarginBalancePushDataJSON)), "%s websocket cross margin balance push data should not error", e.Name)
}
...
func TestCrossMarginBalanceLoan(t *testing.T) {
	t.Parallel()
	assert.NoErrorf(t, e.WsHandleSpotData(t.Context(), nil, []byte(wsCrossMarginBalanceLoan)), "%s websocket cross margin loan push data should not error", e.Name)
}
...
func TestOptionsContractTickerPushData(t *testing.T) {
	...
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options contract ticker push data without error for %s", e.Name)
}
...
func TestOptionsUnderlyingTickerPushData(t *testing.T) {
	...
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options underlying ticker push data without error for %s", e.Name)
}
...
func TestOptionsContractTradesPushData(t *testing.T) {
	...
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options contract trades push data without error for %s", e.Name)
}
...
func TestOptionsUnderlyingTradesPushData(t *testing.T) {
	...
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options underlying trades push data without error for %s", e.Name)
}
...
func TestOptionsUnderlyingPricePushData(t *testing.T) {
	...
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options underlying price push data without error for %s", e.Name)
}
...
func TestOptionsMarkPricePushData(t *testing.T) {
	...
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options mark price push data without error for %s", e.Name)
}
...
func TestSettlementsPushData(t *testing.T) {
	t.Parallel()
	err := e.WsHandleOptionsData(t.Context(), nil, []byte(optionsSettlementsPushDataJSON))
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options settlements push data without error for %s", e.Name)
}
...
func TestOptionsContractPushData(t *testing.T) {
	...
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options contracts push data without error for %s", e.Name)
}
...
func TestOptionsCandlesticksPushData(t *testing.T) {
	t.Parallel()
	err := e.WsHandleOptionsData(t.Context(), nil, []byte(optionsContractCandlesticksPushDataJSON))
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options contract candlestick push data without error for %s", e.Name)
	err = e.WsHandleOptionsData(t.Context(), nil, []byte(optionsUnderlyingCandlesticksPushDataJSON))
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options underlying candlestick push data without error for %s", e.Name)
}
...
func TestOptionsOrderPushData(t *testing.T) {
	t.Parallel()
	err := e.WsHandleOptionsData(t.Context(), nil, []byte(optionsOrderPushDataJSON))
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options orders push data without error for %s", e.Name)
}
...
func TestOptionUserTradesPushData(t *testing.T) {
	t.Parallel()
	err := e.WsHandleOptionsData(t.Context(), nil, []byte(optionsUsersTradesPushDataJSON))
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options user trades push data without error for %s", e.Name)
}
...
func TestOptionsLiquidatesPushData(t *testing.T) {
	t.Parallel()
	err := e.WsHandleOptionsData(t.Context(), nil, []byte(optionsLiquidatesPushDataJSON))
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options liquidates push data without error for %s", e.Name)
}
...
func TestOptionsSettlementPushData(t *testing.T) {
	t.Parallel()
	err := e.WsHandleOptionsData(t.Context(), nil, []byte(optionsSettlementPushDataJSON))
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options settlement push data without error for %s", e.Name)
}
...
func TestOptionsPositionClosePushData(t *testing.T) {
	t.Parallel()
	err := e.WsHandleOptionsData(t.Context(), nil, []byte(optionsPositionClosePushDataJSON))
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options position close push data without error for %s", e.Name)
}
...
func TestOptionsBalancePushData(t *testing.T) {
	t.Parallel()
	ctx := account.DeployCredentialsToContext(t.Context(), &account.Credentials{Key: "test", Secret: "test"})
	err := e.WsHandleOptionsData(ctx, nil, []byte(optionsBalancePushDataJSON))
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options balance push data without error for %s", e.Name)
}
...
func TestOptionsPositionPushData(t *testing.T) {
	t.Parallel()
	err := e.WsHandleOptionsData(t.Context(), nil, []byte(optionsPositionPushDataJSON))
	assert.NoErrorf(t, err, "WsHandleOptionsData should handle options position push data without error for %s", e.Name)
}
...
func TestGenerateDeliveryFuturesDefaultSubscriptions(t *testing.T) {
	...
	assert.NoError(t, err, "GenerateDeliveryFuturesDefaultSubscriptions should not error")
}
...
func TestGenerateOptionsDefaultSubscriptions(t *testing.T) {
	...
	assert.NoError(t, err, "GenerateOptionsDefaultSubscriptions should not error")
}
...
func TestCreateAPIKeysOfSubAccount(t *testing.T) {
	...
	assert.NoError(t, err, "CreateAPIKeysOfSubAccount should not error")
}
...
func TestListAllAPIKeyOfSubAccount(t *testing.T) {
	...
	assert.NoError(t, err, "GetAllAPIKeyOfSubAccount should not error")
}
...
func TestUpdateAPIKeyOfSubAccount(t *testing.T) {
	...
	assert.NoError(t, err, "UpdateAPIKeyOfSubAccount should not error")
}
...
func TestGetAPIKeyOfSubAccount(t *testing.T) {
	...
	assert.NoError(t, err, "GetAPIKeyOfSubAccount should not error")
}
...
func TestLockSubAccount(t *testing.T) {
	...
	assert.NoError(t, err, "LockSubAccount should not error")
}
...
func TestUnlockSubAccount(t *testing.T) {
	...
	assert.NoError(t, err, "UnlockSubAccount should not error")
}
...
func TestForceFileStandard(t *testing.T) {
	...
	require.NoError(t, err, "ForceFileStandard must not return error")
	require.False(t, t.Failed(), "ForceFileStandard must not detect disallowed float64 usage; please use types.Number type instead of float64 and remove ,string before calling Float64")
}
