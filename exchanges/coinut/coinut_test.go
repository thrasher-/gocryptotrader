...
func TestGetInstruments(t *testing.T) {
	...
	require.NoError(t, err, "GetInstruments must not return error")
}

func TestSeedInstruments(t *testing.T) {
	require.NoError(t, e.SeedInstruments(t.Context()), "SeedInstruments must not return error")
...
func TestGetAccountInfo(t *testing.T) {
	...
	if apiKey != "" || clientID != "" {
		require.NoError(t, err, "UpdateAccountInfo must not return error when credentials set")
	} else {
		assert.Error(t, err, "UpdateAccountInfo should return error when credentials unset")
	}
}
...
func TestWsAuthGetAccountBalance(t *testing.T) {
	...
	require.NoError(t, err, "wsGetAccountBalance must not return error")
}
