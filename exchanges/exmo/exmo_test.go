...
func TestGetTicker(t *testing.T) {
	...
	require.NoError(t, err, "GetTicker must not return error")
}

func TestGetPairSettings(t *testing.T) {
	t.Parallel()
	_, err := e.GetPairSettings(t.Context())
	require.NoError(t, err, "GetPairSettings must not return error")
}

func TestGetCurrency(t *testing.T) {
	t.Parallel()
	_, err := e.GetCurrency(t.Context())
	require.NoError(t, err, "GetCurrency must not return error")
}
...
func TestGetUserInfo(t *testing.T) {
	...
	require.NoError(t, err, "GetUserInfo must not return error")
}
...
func TestGetFeeByTypeOfflineTradeFee(t *testing.T) {
	...
	require.NoError(t, err, "GetFeeByType must not return error")
...
func TestGetCryptoDepositAddress(t *testing.T) {
	...
	require.NoError(t, err, "GetCryptoDepositAddress must not return error")
}
...
func TestGetCryptoPaymentProvidersList(t *testing.T) {
	...
	require.NoError(t, err, "GetCryptoPaymentProvidersList must not return error")
}
...
func TestGetAccountFundingHistory(t *testing.T) {
	...
	require.NoError(t, err, "GetAccountFundingHistory must not return error")
}
...
func TestGetWithdrawalsHistory(t *testing.T) {
	...
	require.NoError(t, err, "GetWithdrawalsHistory must not return error")
}
